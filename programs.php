...
<head>
    ...
    <title>Programs - CareVisio</title>
...
<body>
    ...
    <div class="tabbed-container">
        ...
        <div class="tab-content active" id="tab1">
            ...
            <div class="prcon" onclick="openProgramContent(<?php echo $program['id']; ?>)">
                <div class="prcontent">
                    ...
                    <p style="font-size: x-small; color: #888D8F;" class="pgType"><?php echo $program['program_type']; ?></p>
                </div>
                <?php
        ...
        <!-- Add more content sections for other tabs with similar structure -->
