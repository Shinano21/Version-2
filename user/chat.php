<?php 
  // // Include the navbar.php 
  include_once "navbar.php";

  include_once "dbcon.php";
  // Check if the 'user_id' parameter is not set in the URL
...
<head>
  ...
  <style>
    /* Override scrollbar styles for chat.php */
    body.chat-page {
      overflow-y: hidden; /* or 'auto' if you want automatic scrollbar when needed */
    }
   ...
   <img class="user-avatar" src="../uploads/<?php echo basename($row['profile_image']); ?>" alt="User Avatar">
    <div class="user-info">
        ...
        <section class="users">
            ...
            <div  class="messages-text"> <p><i class="fas fa-comment"></i>&nbsp;&nbsp;Messages </p>
            </div>
      ...
      <?php if ($_GET['user_id'] == $_SESSION['unique_id']) : ?>
        ...
        <?php else : ?>
            ...
            if ($sql) {
                ...
                // echo '<div id="error-message">Error fetching user data</div>';
                // header("refresh:3;url=chat.php?user_id={$_SESSION['unique_id']}");
                exit();
            }
            ?>
