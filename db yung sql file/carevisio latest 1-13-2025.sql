...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2025 at 08:56 AM
...
(4, 3, '2024-12-01', NULL, '2024-12-16', 'Purok 2', 'Foot', 'qsqdqdqd', 'qsqsq');
...
INSERT INTO `hypertension` (`hypertension_id`, `resident_id`, `checkup_date`, `medicine_name`, `medicine_type`, `blood_pressure`, `remarks_type`) VALUES
(3, 1, '2024-12-04', 'Cinnarizine', NULL, '23', 'qwqsqsqsq'),
(4, 11, '2024-12-15', 'Amlodipine', NULL, '34', 'dsfsfsf');
...
--
ALTER TABLE `hypertension`
  MODIFY `hypertension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
