...
<head>
    ...
    <title>Nutrition and Deworming Records | CareVisio</title>
...
<body onload="display_ct();">
            ...
            <div class="container-fluid">
                <div class="row" id="header-row">
                    <div class="title-page">
                        <h1>Nutrition and Deworming Services Records</h1>
                        <h6>Children Age 12-59 months old (1-4 years old)</h6>
                    </div>
                    <div class="bc-page">
                        <ol class="bc">
                ...
                <section id="main-content">
                    <div class="row">
                        ...
                        <div class="buttons">
                            <a href="services/services2.php"><button class="addBtn"><span class="fa fa-plus"></span>&nbsp;&nbsp;Record</button></a>
                            <a href="template/services2.php" target="_blank"><button class="printBtn"><span class="fa fa-print">&nbsp;&nbsp;</span>Print Records</button></a>
                        </div>
                        <div class="tab">
                            ...
                            <table id="residentTable" class="tableResidents">
                                ...
                                <tbody>
                                <?php include "data/showNutrition.php"?>
                                </tbody>   
                            </table>
                            <div class="showPages">
    ...
    <script>
        ...
        function printImmunization() {
            ...
            let printURL = `template/services2.php?year=${selectedYear}`;
