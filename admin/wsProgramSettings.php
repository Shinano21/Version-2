            ...
            <div class="container-fluid">
                <section id="main-content">
                    <div class="tab">
                        ...
                        <button class="tablinks" onclick="openTab(event, 'Tab2')">Programs</button>
                    </div>

                    <div id="Tab1" class="tabcontent">
                        <form action="cms/edit_programs.php" method="post" enctype="multipart/form-data">
                            <div class="form">
                                ...
                                <div class="photo">
                                    ...
                                    <div class="preview">
                                        ...
                                        if ($programsPic !== null) {
                                            ...
                                            echo "<img id='preview' src='data:image/{$imageType};base64," . base64_encode($programsPic) . "' alt='Preview' style='max-width:250px; max-height:250px;'>";
                                        } else {
                    ...
                    <div id="Tab2" class="tabcontent">
                        ...
                        <div class="addUser">
                            <a href="wsAddPrograms.php" class="addUs">
                        ...
                        <div class="table">
                            ...
                            <table id="userTable">
                                ...
                                <tbody>
                                    <?php include "data/showPrograms.php"; ?>
                                </tbody>
