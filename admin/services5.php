...
<head>
    ...
    <title>Anti-pneumonia Vaccination Records | CareVisio</title>
...
<body onload="display_ct();">
            ...
            <div class="container-fluid">
                <div class="row" id="header-row">
                    <div class="title-page">
                        <h1>Anti-pneumonia Vaccination Records</h1>
                        <h6>Anti-pneumonia Vaccine Recipients</h6>
                    </div>
                    <div class="bc-page">
                        <ol class="bc">
                ...
                <section id="main-content">
                    <div class="row">
                        ...
                        <div class="buttons">
                            <a href="services/services5.php"><button class="addBtn"><span class="fa fa-plus"></span>&nbsp;&nbsp;Record</button></a>
                            <a href="template/services5.php" target="_blank"><button class="printBtn"><span class="fa fa-print">&nbsp;&nbsp;</span>Print Records</button></a>
                        </div>
                        <div class="tab">
                            ...
                            <table id="residentTable" class="tableResidents">
                                ...
                                <tbody>
                                <?php include "data/showPneumonia.php"?>
                                </tbody>   
                            </table>
                            <div class="showPages">
    ...
    <script>
        ...
        function printImmunization() {
            ...
            let printURL = `template/services5.php?year=${selectedYear}`;
