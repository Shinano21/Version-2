...
<head>
    ...
    <title>Family Planning Records | CareVisio</title>
...
<body onload="display_ct();">
            ...
            <div class="container-fluid">
                <div class="row" id="header-row">
                    <div class="title-page">
                        <h1>Family Planning Services Records</h1>
                        <h6>Target Client List</h6>
                    </div>
                    <div class="bc-page">
                        <ol class="bc">
                ...
                <section id="main-content">
                    <div class="row">
                        ...
                        <div class="buttons">
                            <a href="services/services3.php"><button class="addBtn"><span class="fa fa-plus"></span>&nbsp;&nbsp;Record</button></a>
                            <a href="template/services3.php" target="_blank"><button class="printBtn"><span class="fa fa-print">&nbsp;&nbsp;</span>Print Records</button></a>
                        </div>
                        <div class="tab">
                            ...
                            <table id="residentTable" class="tableResidents">
                                ...
                                <tbody>
                                <?php include "data/showFamilyPlanning.php"?>
                                </tbody>   
                            </table>
                            <div class="showPages">
    ...
    <script>
        ...
        function printImmunization() {
            ...
            let printURL = `template/services3.php?year=${selectedYear}`;
