...
<head>
    ...
    <title>Update Immunization and Nutrition Record | CareVisio</title>
...
?>
    ...
    <tr>
        ...
        <th>
            <br>
            <label>MIDDLE NAME<span class="req">*</span></label><br>
            <input type="text" name="mother_mname" required value=<?php echo $row["mother_mname"];?>>
        </th>
        <th>
            <br>
            <label>LAST NAME<span class="req">*</span></label><br>
    ...
    <tr>
        <th>
            ...
            <select id="purokSelect" name="zone">
                ...
                <option value="Purok 3A" <?php echo ($row["zone"] == "Purok 4") ? "selected" : ""; ?>>Purok 4</option>
                <option value="Purok 3B" <?php echo ($row["zone"] == "Purok 5") ? "selected" : ""; ?>>Purok 5</option>
                <option value="Purok 4A" <?php echo ($row["zone"] == "Purok 6") ? "selected" : ""; ?>>Purok 6</option>
            </select>
        </th>
        <th>
...
<div class="sectioning"  id="a7">
    ...
    <br>
                        <br>
                        <button type="submit" name="updateImmu" value='<?php echo $id;?>'>Save</button>
                        <br>
                        <br>
                        <br>
                        <hr>
