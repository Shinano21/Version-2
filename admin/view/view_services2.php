...
<head>
    ...
    <title>View Nutrition and Deworming Record | CareVisio</title>
...
<table>
    ...
    <tr>
        ...
        <th>Child given 2 doses of deworming drug<br>
            <input type="radio" name="deworming_yn4" <?php if($row1["deworming_yn"]=="Yes"){echo "checked";}?>>&nbsp;Yes&nbsp;&nbsp;&nbsp;
            <input type="radio" name="deworming_yn4" <?php if($row1["deworming_yn"]=="No"){echo "checked";}?>>&nbsp;No
        </th>
    </tr>
</table>
...
?>
        ...
        <th>
            <div class="opp"><input type="radio" name="sam5" value="Died"  <?php if($row1["sam_status"]=="Died"){echo "checked";}?>>&nbsp;&nbsp;Died</div>
                        ...
                        <br>
                        <br>
                       <!-- <button type="submit" name="add_nutrition" value="<?php echo $row1["id"];?>">Save</button>-->
                        <br>
                        <br>
                        <br>
                        <hr>
