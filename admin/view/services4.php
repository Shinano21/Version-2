...
<head>
    ...
    <title>Update Influenza Vaccination Record | CareVisio</title>
                ...
                <div class="row">
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            ...
                            <a href="../services4.php"><h7><i class="fa fa-long-arrow-left">&nbsp;&nbsp;</i>
                            Back to Influenza Vaccination Records</h7></a>
                                <h1>Update Record</h1>
...
$id=$_GET["update"];
$query = "SELECT * FROM `influenza_vaccination` WHERE `id` = $id LIMIT 1";
...
<option value="Purok 6" <?php echo ($row["zone"] == "Purok 6") ? "selected" : ""; ?>>Purok 6</option>
    ...
    <th>
        ...
        <input 
            ...
            value="<?php echo htmlspecialchars($row['city_municipality']); ?>" 
            required
        >
    </th>
    <th>
        ...
        <tr>
            ...
            <th>
                DATE OF BIRTH<span class="req">*</span><br><input type="date" name="date_of_birth" required value="<?php echo $row["date_of_birth"];?>">
                            ...
                            <br>
                        <br>
                        <button type="submit" name="addinflu" value="<?php echo $id;?>">Save</button>
                        <br>
                        <br>
                        <br>
                        <hr>
