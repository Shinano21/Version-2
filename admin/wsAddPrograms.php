...
<head>
    <title>Add Programs | CareVisio</title>
    ...
    <div class="content-wrap">
        <div class="main">
            ...
            <div class="container-fluid">
                <h5 style="padding: 25px 30px 0;">Programs / Add New Program</h5>
                <section id="main-content">
                    <div class="tabcontent show">
                        <form action="cms/edit_programs_content.php" method="post" enctype="multipart/form-data">
                            <div class="form">
                                <h5>Program</h5>
                                ...
                                <div class="formInput" style="width: 100%;">
                                    <label>Heading</label>
                                    <input type="text" name="prog_heading" placeholder="Enter data" required>
                                </div>
                                <div class="formInput" style="width: 100%;">
                                    <label>Body</label>
